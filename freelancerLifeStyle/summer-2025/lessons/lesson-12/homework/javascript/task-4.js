...
if (confirm("Почати тестування?")) {
    ...
    <li>
      <p>
        ...
        <ul class="list">
  `);
    let numbersArrayForBubbleSort = createArray(ELEMENTS_AMOUNT, RANDOM_NUMBER_FROM, RANDOM_NUMBER_TO);
    document.write(`
...
`);
    let numbersArrayForShakerSort = createArray(ELEMENTS_AMOUNT, RANDOM_NUMBER_FROM, RANDOM_NUMBER_TO);
...
`);
    let numbersArrayForInsertionSort = createArray(ELEMENTS_AMOUNT, RANDOM_NUMBER_FROM, RANDOM_NUMBER_TO);
  ...
  `);
    ...
    function showChangeArrayInsertionSort(array) {
        let changeCounter = 0;
    ...
    function showChangeArrayShakerSort(array) {
    ...
    function showChangeArrayBubbleSort(array) {
