...
if (confirm("Почати тестування?")) {
  ...
  `);
    ...
    const productTotalPrice = dataList.reduce((previousSum, product) => previousSum + product.price, 0);
    document.write(`
    <li class="list__item">
  ...
  `);
    ...
    const productAmountPriceDecreased = dataList.reduce((previousProductAmount, product) => product.price < product.old_price
        ? previousProductAmount + 1
        : previousProductAmount, 0);
    document.write(`
    <li class="list__item">
  ...
  `);
    ...
    const productsAvailable = dataList.filter((product) => product.sell_status === "available");
    console.log('3) Товари, які доступні (sell_status:"available") :>> ', productsAvailable);
    document.write(`
    <li class="list__item">
  ...
  `);
    ...
    const productsAvailableShortFormat = dataList
    ...
    console.log("4) Новий список об'єктів тільки доступних для продажу товарів :>> ", productsAvailableShortFormat);
    document.write(`
    <li class="list__item">
