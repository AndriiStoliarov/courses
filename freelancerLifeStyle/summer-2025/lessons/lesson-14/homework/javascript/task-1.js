...
const sitesTotalPrice = sites.reduce((previousSum, price) => previousSum + price.siteCost, 0);
document.write(`
  <li class="list__item">
...
const sitesAmountReleased = sites.reduce((previousSitesAmount, year) => year.releaseYear >= 2000 && year.releaseYear <= 2009
